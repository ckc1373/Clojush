...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; crossover hotspot alternation

(defn hotspot-alternation
  "Alternates between two parent genomes based on the probability factor of the
  :hotspot marker, similar to regular alternation"
  [parent1 parent2 {:keys [alignment-deviation
                           max-points maintain-ancestors] :as argmap}]
  (let [alignment-deviation (random-element-or-identity-if-not-a-collection alignment-deviation)
        s1 (:genome parent1)
        s2 (:genome parent2)
        new-genome (loop [i 0
                          use-s1 (lrand-nth [true false])
